...
set poolname=miningpoolhubcoins,zpool,miningpoolhub
set ExcludePoolName=zergpool
...
set algorithm=ethash,lyra2re2,equihash,neoscrypt,lyra2z,m7m,xevan,hmq1725,blake2s,c11,phi,x17,bitcore,x11evo,hsr,yescrypt,tribus,lyra2v2,keccakc,sha256t
set ExcludeAlgorithm=ethash2gb,keccak,cryptonight
