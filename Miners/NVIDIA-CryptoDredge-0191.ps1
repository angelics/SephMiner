...
$Type = "NVIDIA"
$Path = ".\Bin\NVIDIA-CryptoDredge-0191\CryptoDredge.exe"
$API  = "Ccminer"
...
$Commands = [PSCustomObject[]]@(
    ...
    #[PSCustomObject]@{Algorithm = "argon2ddyn"; Params = ""; Zpool = ""; ZergpoolCoins = ""} #argon2ddyn NVIDIA-CryptoDredge-0202
    ...
    #[PSCustomObject]@{Algorithm = "mtp"; Params = ""; Zpool = ""; MiningPoolHubCoins = ""; ZergpoolCoins = ""; fee=2} #mtp ~ 5GB VRAM unstable
    ...
    #[PSCustomObject]@{Algorithm = "x16r"; Params = ""; Zpool = ""; ZergpoolCoins = ""} #x16r NVIDIA-TRex-092
    ...
    #[PSCustomObject]@{Algorithm = "x17"; Params = ""; Zpool = ""; ZergpoolCoins = ""} #x17 NVIDIA-TRex-092, NVIDIA-TRex-0121
    #[PSCustomObject]@{Algorithm = "x21s"; Params = ""; Zpool = ""; ZergpoolCoins = ""} #x21s NVIDIA-CryptoDredge-0180
