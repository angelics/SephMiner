...
$Type = "NVIDIA"
$Path = ".\Bin\Claymore-Eth-150\EthDcrMiner64.exe"
$API  = "Claymore"
$Uri  = "http://semitest.000webhostapp.com/binary/Claymore's%20Dual%20Ethereum%20AMD+NVIDIA%20GPU%20Miner%20v15.0.zip"
