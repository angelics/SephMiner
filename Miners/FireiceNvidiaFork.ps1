...
$Path = ".\Bin\CryptoNight-FireIce-Fork\xmr-stak.exe"
$Uri = "https://drive.google.com/drive/folders/14r_lQUyY-CosDvuMAGOyUZV88TIj7e2w?usp=sharing"
...
[PSCustomObject]@{
    ...
    HashRates = [PSCustomObject]@{CryptoNight = $Stats."$($Name)_CryptoNightFork_HashRate".Week}
    API       = "XMRig"
    Port      = $Port
    URI       = $Uri
}