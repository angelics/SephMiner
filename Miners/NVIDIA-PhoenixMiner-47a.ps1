...
$Type = "NVIDIA"
$Path = ".\Bin\PhoenixMiner-47a\PhoenixMiner.exe"
$API  = "Claymore"
$Uri  = "http://semitest.000webhostapp.com/binary/PhoenixMiner_4.7a_Windows.zip"
...
$CommonCommands = " -rvram -1 -eres 0" #eg. " -d 0,1,8,9"
