...
$Type = "AMD"
$Path = ".\Bin\Ethash-Ethminer-0160rc0\ethminer.exe"
$API  = "Claymore"
$Uri  = "https://github.com/ethereum-mining/ethminer/releases/download/v0.16.0rc0/ethminer-0.16.0rc0-windows-amd64.zip"
...
$Commands | Get-Member -MemberType NoteProperty -ErrorAction Ignore | Select-Object -ExpandProperty Name | ForEach-Object {
    ...
    if ($Pools.$Algorithm_Norm -and $DeviceIDs) { # must have a valid pool to mine and available devices
        ...
        [PSCustomObject]@{
            ...
            Type      = $Type
            Path      = $Path
            Arguments = "--api-port $($Port) -P $($Pools.$Algorithm_Norm.Protocol)://$([System.Web.HttpUtility]::UrlEncode($Pools.$Algorithm_Norm.User)):$([System.Web.HttpUtility]::UrlEncode($Pools.$Algorithm_Norm.Pass))@$($Pools.$Algorithm_Norm.Host):$($Pools.$Algorithm_Norm.Port)$($Commands.$_)$($CommonCommands) --opencl --opencl-platform 1 --opencl-devices $($DeviceIDs)"
