...
$Type = "NVIDIA"
$Path = ".\Bin\NVIDIA-ZEnemy-118\z-enemy.exe"
$API  = "Ccminer"
$Uri  = "http://semitest.000webhostapp.com/binary/z-enemy.1-17-cuda9.2_x64.zip"
...
$Commands = [PSCustomObject[]]@(
    ...
    [PSCustomObject]@{Algorithm = "phi"; Params = ""; Zpool = ""; ZergpoolCoins = ""} #Phi NVIDIA-TRex-062
