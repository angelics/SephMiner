...
if ($CUDAVersion -lt [System.Version]("10.0.0")) {
    $Uri = "https://github.com/technobyl/CryptoDredge/releases/download/v0.19.0/CryptoDredge_0.19.0_cuda_9.2_windows.zip"
}
else {
...
$Type = "NVIDIA"
$Path = ".\Bin\NVIDIA-CryptoDredge-0190\CryptoDredge.exe"
$API  = "Ccminer"
...
$Commands = [PSCustomObject[]]@(
    ...
    #[PSCustomObject]@{Algorithm = "argon2ddyn"; Params = ""; Zpool = ""; ZergpoolCoins = ""} #argon2ddyn NVIDIA-CryptoDredge-0180
    [PSCustomObject]@{Algorithm = "argon2d250"; Params = ""; Zpool = ""; ZergpoolCoins = ""} #argon2d250
    [PSCustomObject]@{Algorithm = "argon2d4096"; Params = ""; Zpool = ""; ZergpoolCoins = ""} #argon2d4096
