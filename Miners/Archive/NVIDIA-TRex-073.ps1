...
$Type = "NVIDIA"
$Path = ".\Bin\NVIDIA-TRex-073\t-rex.exe"
$API  = "Ccminer"
$Uri  = "http://semitest.000webhostapp.com/binary/t-rex-0.7.3-win-cuda10.0.zip"
...
$Commands = [PSCustomObject[]]@(
    ...
    #[PSCustomObject]@{Algorithm = "x22i"; Params = ""; Zpool = ""} #x22i NVIDIA-CryptoDredge-0100
