...
if ($CUDAVersion -lt [System.Version]("10.0.0")) {
    $Uri = "http://semitest.000webhostapp.com/binary/z-enemy-2.2-cuda9.2.zip"
}
else {
    $Uri = "http://semitest.000webhostapp.com/binary/z-enemy-2.2-cuda10.0.zip"
}

$Type = "NVIDIA"
$Path = ".\Bin\NVIDIA-ZEnemy-220\z-enemy.exe"
$API  = "Ccminer"
