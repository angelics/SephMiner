...
if ($CUDAVersion -lt [System.Version]("10.0.0")) {
    $Uri = "https://github.com/trexminer/T-Rex/releases/download/0.11.1/t-rex-0.11.1-win-cuda9.2.zip"
}
else {
    $Uri = "hhttps://github.com/trexminer/T-Rex/releases/download/0.11.1/t-rex-0.11.1-win-cuda10.0.zip"
}

$Type = "NVIDIA"
$Path = ".\Bin\NVIDIA-TRex-0111\t-rex.exe"
$API  = "Ccminer"
