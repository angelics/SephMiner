...
$Type = "NVIDIA"
$Path = ".\Bin\NVIDIA-ZEnemy-124\z-enemy.exe"
$API  = "Ccminer"
$Uri  = "http://semitest.000webhostapp.com/binary/z-enemy.1-24-cuda10.0_ver2.zip"
...
$Commands = [PSCustomObject[]]@(
    ...
    #[PSCustomObject]@{Algorithm = "sonoa"; Params = ""} #sonoa NVIDIA-TRex-073
