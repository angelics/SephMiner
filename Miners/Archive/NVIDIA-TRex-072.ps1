...
$Type = "NVIDIA"
$Path = ".\Bin\NVIDIA-TRex-072\t-rex.exe"
$API  = "Ccminer"
$Uri  = "http://semitest.000webhostapp.com/binary/t-rex-0.7.2-win-cuda10.0.zip"
...
$Commands = [PSCustomObject[]]@(
    ...
    #[PSCustomObject]@{Algorithm = "polytimos"; Params = ""; Zpool = ""} #polytimos NVIDIA-CryptoDredge-095
    #[PSCustomObject]@{Algorithm = "phi"; Params = ""; Zpool = ""} #phi NVIDIA-CryptoDredge-095
