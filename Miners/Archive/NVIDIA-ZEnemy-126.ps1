...
$Type = "NVIDIA"
$Path = ".\Bin\NVIDIA-ZEnemy-126\z-enemy.exe"
$API  = "Ccminer"
$Uri  = "http://semitest.000webhostapp.com/binary/z-enemy.1-26-cuda10.0.zip"
$Port = Get-FreeTcpPort -DefaultPort 4068
$Fee  = 1

$Commands = [PSCustomObject[]]@(
    [PSCustomObject]@{Algorithm = "aeriumx"; Params = ""; Zpool = ""} #aeriumx
    #[PSCustomObject]@{Algorithm = "bcd"; Params = ""; Zpool = "";} #bcd NVIDIA-TRex-084
    ...
    #[PSCustomObject]@{Algorithm = "phi2"; Params = ""; Zpool = ""} #Phi2 NVIDIA-CryptoDredge-0130
    ...
    #[PSCustomObject]@{Algorithm = "x16s"; Params = " -i 21"; Zpool = ""} #x16s NVIDIA-TRex-084
    #[PSCustomObject]@{Algorithm = "x16r"; Params = " -i 21"; Zpool = ""} #x16r NVIDIA-TRex-084
