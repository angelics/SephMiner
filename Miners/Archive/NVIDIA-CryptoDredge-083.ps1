...
$Type = "NVIDIA"
$Path = ".\Bin\NVIDIA-CryptoDredge-083\CryptoDredge.exe"
$API  = "Ccminer"
$Uri  = "http://semitest.000webhostapp.com/binary/CryptoDredge_0.8.3_win_x64.zip"
...
$Commands = [PSCustomObject[]]@(
    ...
    [PSCustomObject]@{Algorithm = "skunkhash"; Params = ""; Zpool = ""; ZergpoolCoins = ""} #Skunk NVIDIA-TRex-064
