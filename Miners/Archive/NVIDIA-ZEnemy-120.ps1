...
$Type = "NVIDIA"
$Path = ".\Bin\NVIDIA-ZEnemy-120\z-enemy.exe"
$API  = "Ccminer"
$Uri  = "http://semitest.000webhostapp.com/binary/z-enemy.1-20-cuda9.2_x32_v2.zip"
...
$Commands = [PSCustomObject[]]@(
    ...
    #[PSCustomObject]@{Algorithm = "bitcore"; Params = ""; Zpool = ""; ZergpoolCoins = ""} #Bitcore NVIDIA-TRex-065
    ...
    #[PSCustomObject]@{Algorithm = "phi"; Params = ""; Zpool = ""; ZergpoolCoins = ""} #Phi NVIDIA-TRex-065
    #[PSCustomObject]@{Algorithm = "phi2"; Params = ""; Zpool = ""; ZergpoolCoins = ""} #Phi2 NVIDIA-CryptoDredge-091
    #[PSCustomObject]@{Algorithm = "poly"; Params = ""; Zpool = ""; ZergpoolCoins = ""} #poly NVIDIA-TRex-065
    [PSCustomObject]@{Algorithm = "vit"; Params = ""; Zpool = ""; ZergpoolCoins = ""} #Vitalium
    [PSCustomObject]@{Algorithm = "renesis"; Params = ""} #renesis
    #[PSCustomObject]@{Algorithm = "skunk"; Params = ""; Zpool = ""; ZergpoolCoins = ""} #skunk NVIDIA-TRex-065
    #[PSCustomObject]@{Algorithm = "sonoa"; Params = ""} #sonoa NVIDIA-TRex-065
    [PSCustomObject]@{Algorithm = "timetravel"; Params = ""; Zpool = ""; ZergpoolCoins = ""} #timetravel
    #[PSCustomObject]@{Algorithm = "tribus"; Params = ""; Zpool = ""; ZergpoolCoins = ""} #Tribus NVIDIA-TRex-065 NVIDIA-CryptoDredge-091
    ...
    #[PSCustomObject]@{Algorithm = "x17"; Params = ""; Zpool = ""; ZergpoolCoins = ""} #x17 NVIDIA-TRex-065
