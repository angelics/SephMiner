...
if ($CUDAVersion -lt [System.Version]("10.0.0")) {
    $Uri = "https://github.com/technobyl/CryptoDredge/releases/download/v0.20.2/CryptoDredge_0.20.2_cuda_9.2_windows.zip"
}
else {
    $Uri = "https://github.com/technobyl/CryptoDredge/releases/download/v0.20.2/CryptoDredge_0.20.2_cuda_10.0_windows.zip"
}

$Type = "NVIDIA"
$Path = ".\Bin\NVIDIA-CryptoDredge-0202\CryptoDredge.exe"
$API  = "Ccminer"
...
$Commands = [PSCustomObject[]]@(
    ...
    #[PSCustomObject]@{Algorithm = "argon2ddyn"; Params = ""; Zpool = ""; ZergpoolCoins = ""} #argon2ddyn NVIDIA-CryptoDredge-0191
