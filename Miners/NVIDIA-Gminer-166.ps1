...
$Type = "NVIDIA"
$Path = ".\Bin\NVIDIA-Gminer-166\miner.exe"
$API  = "Gminer"
...
$Commands = [PSCustomObject[]]@(
    [PSCustomObject]@{Algorithm = "BeamHash"; Params = ""} #BeamHash ~ 4/6GB VRAM
    ...
    [PSCustomObject]@{Algorithm = "eaglesong"; Params = ""} #eaglesong
...
$CommonCommands = " --watchdog 0 --nvml 0"
