...
$Zergpool_Request | Get-Member -MemberType NoteProperty -ErrorAction Ignore | Select-Object -ExpandProperty Name | Where {$DisabledAlgorithms -notcontains (Get-Algorithm $_.name)} |Where-Object {$Zergpool_Request.$_.hashrate -gt 0} | ForEach-Object {
