...
$NiceHash_Request.result.simplemultialgo | Where-Object { [Double]$_.paying -gt 0.00 } | Where {$DisabledAlgorithms -inotcontains (Get-Algorithm $_.name)} |ForEach-Object {
