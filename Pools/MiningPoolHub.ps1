...
$MiningPoolHub_Request.return | Where-Object {$_.pool_hash -gt 0} | Where-Object {$_.algo -ne "qubit"} | Where-Object {$_.algo -ne "scrypt"} | Where-Object {$_.algo -ne "x11"} | Where-Object {$_.algo -ne "Myriad-Groestl"} | Where-Object {$_.algo -ne "skein"} | Where-Object {$_.algo -ne "cryptonight"} | ForEach-Object {
