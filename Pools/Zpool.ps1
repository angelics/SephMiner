...
$Zpool_Request | Get-Member -MemberType NoteProperty -ErrorAction Ignore | Select-Object -ExpandProperty Name | Where-Object { [Double]$Zpool_Request.$_.estimate_current -gt 0.00 } | Where-Object {$Zpool_Request.$_.hashrate -gt 0} | Where-Object {$Zpool_Request.$_.name -ne "scrypt"} | Where-Object {$Zpool_Request.$_.name -ne "sha256"} | Where-Object {$Zpool_Request.$_.name -ne "x11"} | Where-Object {$Zpool_Request.$_.name -ne "x13"} | Where-Object {$Zpool_Request.$_.name -ne "x14"} | Where-Object {$Zpool_Request.$_.name -ne "qubit"} | Where-Object {$Zpool_Request.$_.name -ne "quark"} | Where-Object {$Zpool_Request.$_.name -ne "lbry"} | Where-Object {$Zpool_Request.$_.name -ne "myr-gr"} | Where-Object {$Zpool_Request.$_.name -ne "skein"} | ForEach-Object {
