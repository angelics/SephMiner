...
while ($true) {
	...
	$ActiveMiners | Where-Object {$_.GetStatus() -EQ "Running"} | ForEach-Object {$_.Profit_Bias = if ($PoolsInSync) {$_.Profit} else {$_.Profit_Comparison}}
