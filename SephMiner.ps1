...
while ($true) {
    ...
    $ActiveMiners | Where-Object Activated -GT 0 | Sort-Object -Property Status, @{Expression = {$_.GetActiveLast()}; Ascending = $false} | Select-Object -First (1 + 6 + 6) | Format-Table -Wrap -GroupBy Status (
