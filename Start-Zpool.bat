...
set poolname=zpool
set ExcludePoolName=miningpoolhubcoins,miningpoolhub
...
set algorithm=equihash,neoscrypt,lyra2z,m7m,xevan,hmq1725,blake2s,c11,phi,x17,bitcore,x11evo,hsr,yescrypt,tribus,lyra2v2,keccak,keccakc,sha256t
