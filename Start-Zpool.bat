...
set algorithm=equihash,neoscrypt,lyra2z,m7m,xevan,hmq1725,blake2s,c11,phi,x17,bitcore,x11evo,hsr,sib,yescrypt,tribus,lyra2v2,blakecoin,groestl,nist5,keccak,keccakc,sha256t
