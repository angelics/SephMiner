...
set "command=& .\SephMiner.ps1 -wallet 19pQKDfdspXm6ouTDnZHpUcmEFN8a1x9zo -username SephMiner -workername SephMiner -region europe -currency btc,usd,eur -type amd,nvidia,cpu -poolname nicehash -algorithm cryptonight,decrednicehash,ethash,equihash,lbry,lyra2re2,neoscrypt,pascal,sianicehash,sib,skunk -donate 24 -watchdog -minerstatusurl https://multipoolminer.io/monitor/miner.php -switchingprevention 2"
